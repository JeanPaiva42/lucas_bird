...
public class BunnyHead extends AbstractGameObject {
    ...
    public void init () {
        ...
        // seta atributos de fisica
        terminalVelocity.set(3.0f, 4.0f);
        friction.set(12.0f, 0.0f);
        acceleration.set(0.0f, -25.0f);

        // Seta status especiais
    ...
    @Override
    public void update (float deltaTime) {   //atualiza direçao e tempo de duraçao do power up
